...
public class ChatEnglishActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if(response.isSuccessful() && response.body() !=null){
                    ...
                    try {
                        ...
                        // GPT 응답 UI 업데이트를 메인 스레드에서 실행
                        runOnUiThread(() -> {
                            recognizedTextBuilder.insert(0, "API: " + gptResponse + "\n\n");
